...
const ManageAllOrders = () => {
  ...
  useEffect(() => {
    axios
      .get("https://stark-retreat-38653.herokuapp.com/manageAllOrders")
  ...
  const handleDelete = (id) => {
    ...
    if (proceed) {
      axios
        .delete(`https://stark-retreat-38653.herokuapp.com/deletePurchasedCars/${id}`)
        .then((res) => {
  ...
  const handleEditStatus = (id) => {
    axios.put(`https://stark-retreat-38653.herokuapp.com/updateStatus/${id}`).then((res) => {
